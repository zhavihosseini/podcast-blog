...
<section style="padding-bottom: 0px;padding-top: 0px;direction: rtl">
    <div class="container-fluid">
            <div class="container">
                <p style="color: #1d1d3c;font-size: 35px;direction: rtl;text-align: right;font-weight: bolder;">نتیجه ی جست و جوی شما : {{$name}}</p>
                <br>
            </div>
            <section class="row" style="direction: rtl;padding-top: 0px;margin-right: 5px;">
                <div class="text-center" style="direction: rtl">
                    <form class="text-center" method="get" action="{{route('getinallsnow')}}">
                        <input type="text" name="q" placeholder="جست و جو کنید" style="margin: 5px auto;width: 80%;border-radius: 25px;padding: 15px;outline: none;border: 1px solid lightgrey;box-shadow: none" maxlength="200" required>
                    </form>
                </div>
            </section>
        <div class="container-fluid">
...
<script>
    var site_url = "{{route('getinallsnow')}}";
    var page = 1;
