...
<head>
    ...
    <title>ژاوی | جست و جو در دسته بندی </title>
...
<section style="padding-bottom: 0px;padding-top: 0px;direction: rtl">
    <div class="container-fluid">
        @foreach($gives as $give)
            ...
            @endphp
            <div class="container">
                <p style="color: #1d1d3c;font-size: 35px;direction: rtl;text-align: right;font-weight: bolder;">نتیجه ی جست و جوی شما در دسته : {{$name}}</p>
                @if(!empty($search))
                <p style="color: rgba(29,29,60,0.66);font-size:20px;direction: rtl;text-align: right;font-weight: bold">جست و جوی شما :  " {{$search}} "</p>
                @endif
                <br>
            </div>
            <section class="row" style="direction: rtl;padding-top: 0px;margin-right: 5px;">
                <div class="text-center" style="direction: rtl">
                    <form class="text-center" method="get" action="{{route('searchinte',['names'=>$varsz])}}">
...
<script>
    var site_url = "{{route('searchinte',['names'=>$varsz])}}";
    var page = 1;
