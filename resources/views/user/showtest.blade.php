...
$hashid = $hash->encode($id);
        ...
        <div class="col-md-6">
            ...
            <div class="row" style="direction: rtl;" id="showter">
                <p><img @if(!empty($picuser)) src="{{$explodes}}" @else src="{{asset('prof.jpg')}}" @endif style="width: 35px;border-radius: 50%"><span style="padding: 0px 8px;font-size: 15px"> {{$username}} </span><span style="padding: 0px 8px;font-size: 15px;color: #6d6c69">{{$date}} پیش </span> @if(!empty($dateup))<span style="padding: 0px 8px;font-size: 15px;color: #6d6c69"> آپدیت : {{$dateup}}</span>@endif<span id="paper">
            ...
            <div class="col-md-12" id="colsk">
                <div class="row" style="direction: rtl;">
                    <p><img src="{{asset('bb.jpg')}}" style="width: 35px;border-radius: 50%"><span style="padding: 0px 8px;font-size: 15px"> {{$username}} </span><span style="padding: 0px 8px;font-size: 15px;color: #6d6c69">15 مهر 1400</span><span style="padding: 0px 8px;font-size: 15px;color: #6d6c69"> 6 دقیقه</span></p>
            ...
            <div class="row">
                ...
                <label for="zoomCheck">
                    <img class="zooms" src="{{$imgexp}}" width="100%" style="margin-bottom: 5px">
                </label>
                <br>
                <br>
        ...
        <div class="col-md-3">
            <div class="sticky-bottom displs" id="styos" style="border: 1px solid lightgrey;border-radius: 15px;">
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row">
            <div class="col-md-4" id="colmd" style="direction: rtl">
                ...
                <div class="card-body">
                    <p><a href=""><span id="tagsnow"> خودشناسی </span></a> <a href=""><span id="tagsnow"> {{$category}} </span></a></p>
                    <br>
